...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<nav class="svelte-30hcra"><a href="${escape(base, true) + "/"}" class="svelte-30hcra">Home</a>
    <a href="${escape(base, true) + "/joke"}" class="svelte-30hcra">Joke</a>
    <a href="${escape(base, true) + "/bio"}" class="svelte-30hcra">Bio</a>
    <a href="${escape(base, true) + "/projects"}" class="svelte-30hcra">Projects</a></nav>
...
//# sourceMappingURL=_layout.svelte-472dbe5f.js.map
